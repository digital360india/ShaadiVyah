...
const SocialLinksCard = ({ user, handleEditSocials }) => {
  return (
    <div className="w-full max-w-lg px-5 rounded-lg  text-lg space-y-1 font-Merriweather-Sans overflow-hidden">
      ...
      <div className="w-[170px] md:w-[325px] h-[3px] bg-gradient-border"></div>
      <div className="space-y-5 pt-7 md:pt-14  text-[14px] text-[#4A4A4A]">
        {/* Facebook */}
