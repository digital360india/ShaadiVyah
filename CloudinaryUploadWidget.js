...
class CloudinaryUploadWidget extends Component {
  ...
  componentDidMount()
  {
    const cloudName = "djtaxjr3y"; // replace with your own cloud name
    const uploadPreset = "mbczgw65"; // replace with your own upload preset
  ...
  render() {
    return (
      <button id="upload_widget" className="px-4 py-2 rounded bg-[#A11C5C] text-white">
        Upload
      </button>
    );
  }
